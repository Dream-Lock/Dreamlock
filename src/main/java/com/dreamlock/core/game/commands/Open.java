...
//        Availability containerAvailability = commandUtils.checkItemAvailability(openingItem, commandUtils.inventoryItems);
...
//        List <OutputMessage> outputMessages =  new ArrayList<>();
//
//        Item tempItem = commandUtils.getRoomItem(itemName);
...
//        List <OutputMessage> outputMessages = new ArrayList<>();
//        Door door = commandUtils.getRoomDoor(doorName);
//        if (!door.isLocked()) {
