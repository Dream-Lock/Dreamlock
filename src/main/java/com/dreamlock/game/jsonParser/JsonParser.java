...
public class JsonParser {
     ...
     */
    public List<Item> parseItems(ArrayList<ItemDTO> itemDTOs) {
     ...
     */
    public List<Enemy> parseEnemies(ArrayList<EnemyDTO> enemyDTOs) {
     ...
     */
    public List<Door> parseDoors(ArrayList<DoorDTO> doorDTOs) {
